<template>
  ...
  >
    <p class="custom-font text-h6 font-weight-bold">Lista de Empleados</p>
    <div class="mt-3">
      <v-btn
        ...
        <tr>
          ...
          <td class="text-left">
            <v-btn
              ...
              elevation="0"
              color="#26547c"
              @click="$router.push(`/edit-employee/dep-${row.item.id}`)"
            >
...
const handleDelete = async (id) => {
  await axios
    ...
    .then((r) => {
      handleList();
      Swal.fire("Empleado!", "El registro ha sido eliminado", "success");
      return r.data;
    })
    .catch((e) => {
...
const formatDate = (dateString) => {
  ...
  const formattedDate = date.toLocaleDateString("es-ES", options); // Cambia 'es-ES' según tu localización
