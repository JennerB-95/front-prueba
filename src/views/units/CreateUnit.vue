<template>
  ...
  >
    <p class="custom-font text-h6 font-weight-bold mb-5">Agregar unidad</p>
...
const submit = handleSubmit(async (values) => {
  try {
    const response = await axios.post("api/v1/unit/create/", {
      code: values.code,
      name: values.name,
    });
    Swal.fire("¡Unidad!", "El registro ha sido creado", "success");
