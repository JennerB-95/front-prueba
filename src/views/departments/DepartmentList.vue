<template>
  ...
  >
    <p class="custom-font text-h6 font-weight-bold">Lista de Departamentos</p>
    <div class="mt-3">
      <v-btn
    ...
    <v-data-table
      ...
      :items="department"
      :loading="loading"
      :items-length="department.length"
      loading-text="Cargando..."
      items-per-page-text="Departamentos por página"
        ...
        <tr>
          ...
          <td class="text-left">
            <v-btn
              ...
              elevation="0"
              color="#26547c"
              @click="$router.push(`/edit-department/dep-${row.item.id}`)"
            >
...
const handleDelete = async (id) => {
  await axios
    ...
    .then((r) => {
      handleList();
      Swal.fire("Departamento!", "El registro ha sido eliminado", "success");
      return r.data;
    })
    .catch((e) => {
